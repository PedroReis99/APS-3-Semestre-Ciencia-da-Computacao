 ...
 * @author CtSec
 */
public class FrmQuestion7 extends javax.swing.JFrame {
    ...
    public FrmQuestion7() {
        initComponents();
        this.setTitle("SustentableQuiz | Pergunta n°7:");
        lblContinuar.setVisible(false);
        lblPergunta.setText("<html>Tendo em vista que a vida nas metrópoles traz consigo muitas coisas nocivas ao meio ambiente e a sustentabilidade.<br>\n" +
            "Marque a alternativa que corresponde apenas a fatores prejudicais:<html>");
        BtnC.setText("<html> Alta emissão de gases poluente por automóveis e descarte de lixo em <br>locais inadequados.</html>");
        BtnD.setText("<html>Descarte de resíduos incorreto por parte das grandes empresas em rios <br>e consumo consciente de energia</html>");
    ...
    private void initComponents() {
        ...
        lblContinuar.setBounds(692, 476, 142, 100);

        BtnA.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        BtnA.setText("Descarte de lixo em locais inadequados e Economia de água.");
        ...
        lblPergunta.setText("Qual a função da reciclagem?");
        getContentPane().add(lblPergunta);
        lblPergunta.setBounds(12, 64, 860, 80);
        ...
        BtnB.setText("Coleta seletiva de lixo e Automóveis com problemas no sistema de combustão.");
    ...
    private void lblContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblContinuarMouseClicked
        FrmQuestion8 Fq = new FrmQuestion8();
        Fq.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQuestion7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmQuestion7().setVisible(true);
            }
        });
    }
