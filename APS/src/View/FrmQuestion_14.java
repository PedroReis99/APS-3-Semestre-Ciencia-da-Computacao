 ...
 * @author CtSec
 */
public class FrmQuestion_14 extends javax.swing.JFrame {

    /**
     * Creates new form FrmQuestion1
     */
    public FrmQuestion_14() {
        initComponents();
        this.setTitle("SustentableQuiz | Pergunta n°14:");
    ...
    private void initComponents() {
        ...
        BtnA.setText("Evitar o esgotamento dos recursos naturais");
        ...
        jLabel2.setText("Qual o principal objetivo de uma cidade sustentável?");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(12, 98, 600, 26);
        ...
        BtnC.setText("Evitar a inovação e o crescimento econômico");
        ...
        BtnD.setText("Prejudicar a população por meio de burocracias");
        ...
        BtnB.setText("Incentivar a exploração desregulada de recursos naturais");
    ...
    private void lblContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblContinuarMouseClicked
        FrmQuestion_15 Fq = new FrmQuestion_15();
        Fq.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQuestion_14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmQuestion_14().setVisible(true);
            }
        });
    }
