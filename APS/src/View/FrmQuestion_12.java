 ...
 * @author CtSec
 */
public class FrmQuestion_12 extends javax.swing.JFrame {

    /**
     * Creates new form FrmQuestion1
     */
    public FrmQuestion_12() {
        initComponents();
        this.setTitle("SustentableQuiz | Pergunta n°12:");
        lblContinuar.setVisible(false);
        lblPergunta.setText("<html>Os recursos naturais são finitos, quais citados abaixo é o mais<br> prejudicado e utilizado atualmente nas grandes cidades?</html>");
    ...
    private void initComponents() {
        ...
        lblPergunta.setBounds(12, 74, 830, 50);
        ...
        BtnB.setText("Gás natural e Plástico");
    ...
    private void lblContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblContinuarMouseClicked
        FrmQuestion_13 Fq = new FrmQuestion_13();
        Fq.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQuestion_12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmQuestion_12().setVisible(true);
            }
        });
    }
