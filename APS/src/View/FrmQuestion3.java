 ...
 * @author CtSec
 */
public class FrmQuestion3 extends javax.swing.JFrame {
    ...
    public FrmQuestion3() {
        initComponents();
        this.setTitle("SustentableQuiz | Pergunta n°3:");
    ...
    private void initComponents() {
        ...
        lblContinuar.setBounds(687, 476, 147, 100);
        ...
        jLabel2.setText("Qual das alternativas abaixo é um exemplo de Sustentabilidade Social?");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(12, 98, 775, 26);
    ...
    private void lblContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblContinuarMouseClicked
        FrmQuestion4 Fq4 = new FrmQuestion4();
        Fq4.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQuestion3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmQuestion3().setVisible(true);
            }
        });
    }
