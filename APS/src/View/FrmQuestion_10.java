 ...
 * @author CtSec
 */
public class FrmQuestion_10 extends javax.swing.JFrame {

    /**
     * Creates new form FrmQuestion1
     */
    public FrmQuestion_10() {
        initComponents();
        this.setTitle("SustentableQuiz | Pergunta n°10:");
        lblContinuar.setVisible(false);
        lblPontos.setText(Integer.toString(vqc.pontuacao));
        pontos = vqc.pontuacao;
        BtnA.setText("<html>Cidades que alinham os padrões de consumo e produção de forma mais <br>benéfica ao meio ambiente.</html>");
    }
    ...
    private void initComponents() {
        ...
        lblContinuar.setBounds(690, 476, 144, 100);
        ...
        jLabel2.setText("O que são cidades sustentáveis?");
        ...
        BtnC.setText("Despejam resíduos tóxicos no ar e nos rios, os contaminando.");
        ...
        BtnD.setText("Cidades que não incentivam praticas sustentáveis.");
        ...
        BtnB.setText("Promovem o uso descontrolado dos recursos naturais");
    ...
    private void lblContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblContinuarMouseClicked
        if(Dificuldade == "Médio"){
            ...
            FrmQuestion_11 Fq = new FrmQuestion_11();
            Fq.setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQuestion_10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmQuestion_10().setVisible(true);
            }
        });
    }
