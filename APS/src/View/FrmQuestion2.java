 ...
 * @author CtSec
 */
public class FrmQuestion2 extends javax.swing.JFrame {
    ...
    public FrmQuestion2() {
        initComponents();
        this.setTitle("SustentableQuiz | Pergunta n°2:");
        lblContinuar.setVisible(false);
        BtnA.setText("<html>Distribuição de renda com redução das diferenças <br>sociais e melhoria da qualidade de vida.</html>");
        BtnB.setText("<html>Manutenção do meio ambiente do planeta Terra.</html>");
        BtnC.setText("<html>Conjunto de ações que uma empresa toma,<br> visando o respeito ao meio ambiente.</html>");
        BtnD.setText("<html>Conjunto de ações que beneficiam a sociedade e as<br> corporações que são tomadas pelas empresas</html>");
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(904, 598));
        ...
        lblContinuar.setBounds(680, 470, 151, 100);
        ...
        jLabel2.setText("O que é sustentabilidade Social?");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(12, 98, 355, 26);
    ...
    private void lblContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblContinuarMouseClicked
        FrmQuestion3 fq = new FrmQuestion3();
        fq.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQuestion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmQuestion2().setVisible(true);
            }
        });
    }
