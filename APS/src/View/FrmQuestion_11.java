 ...
 * @author CtSec
 */
public class FrmQuestion_11 extends javax.swing.JFrame {

    /**
     * Creates new form FrmQuestion1
     */
    public FrmQuestion_11() {
        initComponents();
        this.setTitle("SustentableQuiz | Pergunta n°11:");
        lblPergunta.setText("<hmtl>Quais são os três aspectos principais para considerar uma cidade<br> considerada ser sustentável?</html>");
    ...
    private void initComponents() {
        ...
        lblContinuar.setBounds(688, 476, 146, 100);

        BtnA.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        BtnA.setText("Financeiro, Ambiental, Esportivo");
        ...
        lblPergunta.setBounds(2, 98, 900, 26);
        ...
        BtnC.setText("Feriados, Lazer, Cultura");
        ...
        BtnD.setText("Social, Esportivo, Trabalhista");
        ...
        BtnB.setText("Social, Ambiental, Econômico");
    ...
    private void lblContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblContinuarMouseClicked
        FrmQuestion_12 Fq = new FrmQuestion_12();
        Fq.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQuestion_11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmQuestion_11().setVisible(true);
            }
        });
    }
