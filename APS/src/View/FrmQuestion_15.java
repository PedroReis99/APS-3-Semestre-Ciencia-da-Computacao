 ...
 * @author CtSec
 */
public class FrmQuestion_15 extends javax.swing.JFrame {

    /**
     * Creates new form FrmQuestion1
     */
    public FrmQuestion_15() {
        this.setTitle("SustentableQuiz | Pergunta n°15:");
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnA.setText("Ônibus, Bicicletas, Veículos Elétricos");
        ...
        jLabel2.setText("Quais dos meios de transporte colaboram para uma cidade ser sustentável?");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(12, 98, 850, 26);
        ...
        BtnD.setText("Carros a combustão, motos, Veículos Elétricos");
        ...
        BtnC.setText("Ônibus, Carros a combustão e Bicicletas");
        ...
        BtnB.setText("Carros a combustão, motos, Bicicletas");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/fundoPerguntas.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQuestion_15.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmQuestion_15().setVisible(true);
            }
        });
    }
